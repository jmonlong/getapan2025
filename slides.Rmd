...
![](imgs/haplotype-sampling1.svg)


## Haplotype sampling for mapping

Simplify graphs by sampling haplotypes similar to reads 
![](imgs/haplotype-sampling2.svg)
...
On the HPRC v2 Minigraph-cactus graph, small variant calling with DeepVariant, structural variant calling with Sniffles2 vs genotyping with `vg call`

![](imgs/giraffe-calling.svg){width=70%}
...
![](imgs/zipcode_snarl_duplication.svg){}

# Inversions in zip code trees

![](imgs/zipcode_snarl_inversion.svg){}
