...
`vg` wiki snarl explainer: https://github.com/vgteam/vg/wiki/Snarls-and-chains

`vg` wiki deconstruct: https://github.com/vgteam/vg/wiki/VCF-export-with-vg-deconstruct
